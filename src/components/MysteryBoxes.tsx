...
const boxes = [
  {
    id: "box-starter",
    title: "Starter Box",
    description: "Perfect for beginners. 2-5 items with guaranteed profit potential.",
    price: 25,
    badge: "Entry Level",
  },
  {
    id: "box-standard",
    title: "Standard Box",
    description: "5-8 quality items. Mix of brands with strong resale value.",
    price: 50,
    popular: true,
  },
  {
    id: "box-premium",
    title: "Premium Box",
    description: "8-12 premium items. Designer and sought-after streetwear pieces.",
    price: 70,
    badge: "Best Value",
  },
  {
    id: "box-elite",
    title: "Elite Box",
    description: "12+ hand-picked items. Rare finds and high-profit potential pieces.",
    price: 90,
    badge: "Top Tier",
  },
];
